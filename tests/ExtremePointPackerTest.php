...
class ExtremePointPackerTest extends TestCase
{
    public function testSingleItemPlacement(): void
    {
        $packer = new ExtremePointPacker(10.0, 10.0, 10.0);
    ...
    {
        $packer = new ExtremePointPacker(5.0, 5.0, 5.0);
    ...
    public function testRotationEnablesFit(): void
    {
        ...
        $packer = new ExtremePointPacker(5.0, 10.0, 5.0);
    ...
    public function testSpaceSplittingCorrectness(): void
    {
        ...
        $packer = new ExtremePointPacker(5.0, 10.0, 10.0);
